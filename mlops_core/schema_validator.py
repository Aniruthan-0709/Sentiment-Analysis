...
logging.basicConfig(
    ...
    handlers=[
        logging.FileHandler(LOG_FILE, encoding="utf-8"),  # Log to file in UTF-8
        logging.StreamHandler(sys.stdout)  # Ensure StreamHandler uses stdout
    ]
)
...
def validate_schema(input_path=PROCESSED_DATA_PATH, schema_path=SCHEMA_PATH):
